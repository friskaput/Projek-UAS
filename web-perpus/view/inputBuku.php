            ...
            <div class="card-body">
                <form method="post">
                    <div class="mb-3">
                        ...
                        <input type="number" name="kode_buku" class="form-control" value="
                        <?php echo @$edit['kode_buku'] ?>" id="exampleFormControlInput1" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul" class="form-control" value="
                            <?php echo @$edit['judul'] ?>" id="exampleFormControlInput1" 
                ...
                <table align="center" border="1" class="mt-4 table table-striped table-hover bg-white" id="tableAll">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="?menu=input_buku&edit&id=<?php echo $r['id']?>"><i 
                                class="bi bi-pen"></i></a></td>
                            <td><a class="text-center" href="?menu=input_buku&hapus&id=
                            <?php echo $r['id']?>" onclick="return confirm('Hapus Data?')">
                            <i class="bi bi-trash text-center"></i></a></td>
                        </tr>
                        <?php } } ?>
                    </tbody>
                </table>
