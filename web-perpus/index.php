  ...
  <body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-center p-2 bd-highlight position-absolute top-50 start-50 translate-middle" >
            <div>
            <center>
                <img class="d-flex justify-content-center pt-2" src="assets/img/login.png" alt="login" height="180">
            </center>
            
            <div id="emailHelp" class="form-text text-center">Silahkan masukkan username dan sandi anda.</div>
            <form action="" method="POST">
                ...
                <div class="mb-0">
                    <label for="exampleFormControlInput1" class="form-label">select user type :</label>
                </div>
                ...
                <div class="d-grid gap-2 mb-1 pt-3">
